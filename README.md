...
- commented Python file with code of three functions used inside the update_web_layers_.pyt ArcGIS tool
- functions can be used on their own in an ArcGIS Notebook
